...
This fork preserves upstream routing behavior and adds only an active-account quota footer.
...
- `Ctrl+Shift+A` cycles to the next authenticated account
...
`accountLabels` optionally gives base accounts a short footer label. Subscription labels are reused automatically.
